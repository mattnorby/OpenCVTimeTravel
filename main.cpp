...
int main(int argc, char *argv[]) {
    ...
    // Here are the points that were used to create the clone.jpg in the repo:
    // (383, 196), (239, 199), (136, 211), (26, 103), (71, 1),
    // (124, 1), (383, 104)
    ...
    if (pts.size() >= 3) {
        ...
        // This step is just for visualization, not necessary for cloning.
        ...
        cout << "Restore foreground portion" << endl;
